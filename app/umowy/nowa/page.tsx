      ...
      >
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2">
          <InfoCard
            ...
            description="Upewnij się, że dane sprzedającego są zgodne z dowodem osobistym lub paszportem."
          />
          <InfoCard
            icon={Info}
            title="Jak przebiega dalej proces"
            description="W kolejnym kroku uzupełnisz dane kupującego, a potem informacje o pojeździe, warunkach sprzedaży i oświadczeniach stron."
          />
        </div>
      </ContractWorkspaceShell>
    </main>
    ...
    <div className="rounded-[24px] border border-[color:var(--dashboard-border)] bg-white/88 p-5 shadow-[0_8px_24px_rgba(38,34,27,0.04)]">
      <div className="flex items-start gap-3">
        <div className="rounded-xl bg-[color:var(--dashboard-accent-soft)] p-2.5">
          <Icon className="h-5 w-5 text-[color:var(--dashboard-accent)]" />
        </div>
        <div>
          <h2 className="text-sm font-semibold text-[color:var(--dashboard-text)]">{title}</h2>
